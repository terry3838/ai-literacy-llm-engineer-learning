...
> [!overview] 주간 개요
> LangGraph 기반 에이전트를 실제 서비스로 배포하는 전 과정을 학습한다. 에이전트 아키텍처 설계, LangGraph MVP 구현, 스트리밍 처리, GitHub Actions CI/CD 파이프라인까지 프로덕션 수준의 서비스 배포를 다룬다. lumi-agent 프로젝트를 통해 실습한다.
...
| Day02 | LangGraph MVP | [[W08D02-LangGraph-MVP]] | lumi-agent v0.2 |
...
## 관련 프로젝트
- [[lumi-agent-v02]] - lumi-agent v0.2 LangGraph MVP
